...
public class XMLHandler extends DefaultHandler {
  ...
  protected static final DateTimeFormatter VISIT_DATE_FORMAT = DateTimeFormatter
      .ofPattern("yyyy.MM.dd HH:mm:ss");
  protected static final DateTimeFormatter SIMPLE_DATE_FORMAT = DateTimeFormatter
      .ofPattern("yyyy.MM.dd");
  protected static final Marker INFO = MarkerManager.getMarker("INFO");
  protected static final Logger logger = LogManager.getRootLogger();
  private static final DateTimeFormatter SIMPLE_DATE_FORMAT_TO_DB = DateTimeFormatter
      .ofPattern("yyyy-MM-dd");
  ...
  public void startElement(String uri, String localName, String qName,
    ...
    if ("voter".equals(qName) && voter == null) {
      ...
      dbConnection.countVoter(voter.getName(),
          SIMPLE_DATE_FORMAT_TO_DB.format(voter.getBirthDay()));
