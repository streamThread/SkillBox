...
public class Main {
  ...
  private static void parseImagesFromHTML(String url,
      String localPathToSaveImages)
    ...
    if (!Files.isDirectory(Path.of(localPathToSaveImages))) {
      throw new IllegalArgumentException(
          "Wrong localPathToSaveImages argument");
    }
    ...
    for (Element image : images) {
      ...
      FileOutputStream out = new FileOutputStream(
          localPathToSaveImages + File.separator + name);
